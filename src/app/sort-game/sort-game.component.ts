    ...
    if (id != null) {
      this.categoryManagementService.get(id).then((category) => {
        ...
        if (this.currentCategory) {
          ...
          firstRandomWordsCurrentCategory = randomWordsCurrentCategory.slice(
            0,
            3
          );
        }
        ...
        this.categoryManagementService.list().then((categories) => {
          ...
          if (this.allCategories && this.currentGame) {
            ...
            if (this.randomCategory) {
              ...
              firstRandomWordsRandomCategory = randomWordsRandomCategory.slice(
                0,
                3
              );
            }
          ...
          if (
            ...
            firstRandomWordsRandomCategory
          ) {
